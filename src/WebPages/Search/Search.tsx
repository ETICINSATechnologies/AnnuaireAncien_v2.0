...
class Search extends Component<{}, SearchState> {
  ...
  makeSearch = (page: number, event?: React.MouseEvent) => {
    ...
    Object.keys(searchArray).forEach(paramName => {
      if (searchArray[paramName] === "") delete searchArray[paramName];
    });
  ...
  render() {
    ...
    Object.keys(searchFields).forEach(fieldName => {
      renderSearchFields.push(
        <div className={`${fieldName}Div`} key={`${fieldName}Div`}>
          {" "}
    ...
    return (
      <React.Fragment>
        ...
        <section className="Search">
          ...
          <MemberArray
            parameters={this.state.searchValues}
